...
Ce fichier permet de comprendre les contraintes imposées que je me suis fixées, mon objectif était de définir un objet de test comprenant ses risques et ses enjeux tout en gardant une cohérence avec mon projet. 
...
Ce dossier comprend deux sous-dossiers : /gif et /images.
Cela me permet d'organiser les différentes preuves que je peux référencer dans mon document rapport-exploratoire

## 📂​ /gif

Grâce à un outil de capture, j'ai rassemblé toutes mes observations faites dans ma session exploratoire pour fournir plus de contexte à mon rapport exploratoire qui sont recensées dans ce dossier sous un format **GIF**

## 📂​ /images

L'utilisation du même outil de capture utilisé pour mes gifs, m'a permis d'ajouter certaines annotations nécessaires à une visualisation plus étendue des différentes observations faites, recensées dans ce dossier sous un format **PNG**
...
Ce dossier comprend plusieurs investigations réalisées, décrivant des anomalies nécessitant plus de détails et de compréhension.
